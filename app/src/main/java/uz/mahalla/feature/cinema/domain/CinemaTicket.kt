 ...
 * не должны «плясать». Талон вида `A-042` из сектора и номера сюда не
 * подходит: сектора у билета нет, и его пришлось бы выдумать, а человек
 * назвал бы кинотеатру номер, которого тот не знает (то же правило, что у
 * талона очереди в issue #96).
