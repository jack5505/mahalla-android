...
enum class PinError {
    ...
    /**
     * Бэкенд вернул токены другого аккаунта (issue #86): `pin-login` ищет
     * пользователя по устройству, а не по подтверждённому номеру. Вход не
     * состоялся — начинаем заново.
     */
    FOREIGN_ACCOUNT,
}
