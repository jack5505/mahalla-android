 ...
 * каталога.
 * @param hourlyRateSum ставка за час в сумах. Бэкенд отдаёт `hourlyRate` в
 * тийинах, пересчёт — `Money.tiyinToSom` в маппере (issue #149). Ноль —
 * «ставка не названа»: экран тогда её просто не показывает, а не пишет «0 сум».
