 ...
 * заказа. Городу и адресу отправиться некуда: `PUT users/me` принимает только
 * `fullName` и `avatarUrl` (`docs/API-CONTRACT.md`). Имя технически может
 * уйти туда же, но пока не уходит — это issue #234, не эта анкета.
 */
@Composable
