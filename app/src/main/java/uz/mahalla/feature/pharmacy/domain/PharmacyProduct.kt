 ...
 * issue #76, #84 и #97 (все три разведены по именам сверкой 2026-09-10, issue
 * #235), — здесь нет и не было.
 *
 ...
 *
 * @param priceSum цена в сумах. Бэкенд отдаёт тийины, пересчёт
 * `Money.tiyinToSom` делает маппер (issue #149).
