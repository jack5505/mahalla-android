...
interface AppointmentsSource {
    ...
    /**
     * Карточка одной записи по id (issue #183) — читается напрямую, а не
     * снимком из списка или из «моих активностей»: статус меняет заведение, и
     * то, что человек видел час назад, ничего не стоит.
     */
