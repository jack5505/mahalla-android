...
data class AppSettings(
    ...
    /**
     * Роль из анкеты (issue #84): `UserRole.storedValue`; `null` — анкету не
     * заполняли, приложение работает как раньше.
     */
    val roleId: String? = null,
    /** Адрес доставки из анкеты покупателя (issue #84); `null` — не задан. */
    ...
    /**
     * Отпечаток SHA-256 сертификата, которому пользователь доверился на экране
     * адреса (issue #32); `null` — доверия не выдавали, сертификаты проверяются
