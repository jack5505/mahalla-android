...
android {
    ...
    defaultConfig {
        // Не minSdk приложения (26): `BaselineProfileRule` помечен
        // `@RequiresApi(28)` — снять профиль на API 26–27 нечем. Замер старта
        // работал бы и ниже, но разводить в одном модуле два минимальных API
        // незачем. На сборку приложения это не влияет: модуль в APK не
        // попадает.
        minSdk = 28
        targetSdk = 35
