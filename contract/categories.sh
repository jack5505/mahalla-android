...
# Прежнее значение возвращаем, а не ставим 1: запусти пробу как
# `CONTRACT_GEO_HEADERS=0 contract/categories.sh`, и жёсткая единица сделала бы
# основную фикстуру снятой без гео, а сравнение ниже — сравнением ответа с
# самим собой.
