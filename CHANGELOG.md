...
### Пункт 4 issue: источник истины у PIN — вынесен в ADR 0006
...
отказе Keystore — в [ADR 0006](docs/adr/0006-server-pin-i-app-lock.md).
...
- **`.claude/rules/security.md` создать не удалось** — запись в `.claude/`
  запрещена агенту. Правило про источник истины ушло в `AGENTS.md` и ADR 0006,
