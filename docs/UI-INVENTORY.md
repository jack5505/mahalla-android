...
| Заказы | ~~`feature/orders/ui/OrdersScreen.kt`~~ → `feature/activity/ui/ActivityScreen.kt` | **сделано** (issue #73, задача A3): «Мои активности» — список из пяти источников, фильтр «активные/история», частичный отказ, догрузка |
