...
- **Редизайн «Focus» (PR #283) опережает бэкенд в трёх местах**, и это
  зафиксировано issue, а не додумано: бронирование шторкой (#285 — нужен
  ...
  Бейдж талона на табе «Мои активности» (#284) решён осознанным
  расхождением с макетом, а не додумыванием бэкенда — [ADR
  0011](adr/0011-badge-talona-ne-na-tabe.md): талона нет в данных «Моих
  активностей», и заводить его туда шестым источником раньше времени, пока
  открыты #208/#213 (пагинация того же списка), не стали — см. #287.
