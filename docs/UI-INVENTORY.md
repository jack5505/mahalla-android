...
| Кабинет мастера | `GET/POST freelancers/me`, `me/services*`, `PUT me/toggle-availability`, `PUT freelancers/orders/{id}/status` | issue #190: подключено, контракт не сверен со стендом (`docs/API-CONTRACT.md`) |
