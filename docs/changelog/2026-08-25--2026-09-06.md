# История разработки — архив: 2026-08-25 … 2026-09-06

Первые 46 разделов `CHANGELOG.md`: от каркаса до вертикали «Игровые зоны»
(issue #5 … #98, эпики 1–7). Вынесены 2026-09-10: журнал дорос до 6.5 тысячи
строк, и агент, открывший его «посмотреть грабли», тратил на историю десятки
тысяч токенов — а нужна она по конкретному поводу.

Текст перенесён без правок: «выше» и «ниже» в разделах относятся к этому
файлу. Продолжение — в [CHANGELOG.md](../../CHANGELOG.md).

Ищи по номеру issue, целиком не читай:
